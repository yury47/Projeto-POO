...
1 - Abra o arquivo de texto "infoAluno", na pasta raíz do programa, e preencha as seguintes informações a fim de instruir o programa com os dados corretos:
...
2 - Acesse o portal do aluno (aluno.ufabc.edu.br) para baixar o arquivo JSON que contém as informações de suas matérias cursadas.
